...
class _language_pageState extends State<language_page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<language_page_provider>(
  ...
  Widget getlangGrid(
    ...
    return GridTile(
      child: InkWell(
        onTap: () {
          context.read<language_page_provider>().changed_lang(
            lang,
            LangCode,
            LangCountry,
          );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: context.watch<language_page_provider>().selectedLang == lang
                ? Color(0xffe9f6ff)
                : Colors.white,
            borderRadius: BorderRadius.circular(10),
            border: Border.all(
              color:
                  context.watch<language_page_provider>().selectedLang == lang
                  ? Color(0xff2667FF)
                  : Colors.grey,
              width: 1,
            ),
