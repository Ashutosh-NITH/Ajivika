...
class choosing_page extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Tell us your profession".tr, style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, ),),
              ),
              SizedBox( height: 10,),
              Padding(
                padding: const EdgeInsets.only(left: 20.0 , right: 20.0),
                child: Text("Please tell us what you do and we will help you find out relevant jobs or workers".tr,style: TextStyle(color: Colors.grey.shade700), ),
              ),


              //body
              Expanded(
                child: Consumer(builder: (ctx , index , __){
                  return ListView(
                    children: [
                      select_profession_card(ctx , CONTRACTOR, "I am a contractor and I need workers/labours".tr),
                      select_profession_card(ctx , WORKER, "I am a worker and I need job".tr),
                    ],
                  );
                })
              ),
              ...
              // Next Button
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: context.watch<ChoosingPageProvider>().selected_profession.isNotEmpty?  Color(0xff2667FF) : Color(0xff8ea9f9),
  ...
  Widget select_profession_card (BuildContext context, String Profession , String subtitle){

    return Container(
      margin: EdgeInsets.all(20.0),
      decoration: BoxDecoration(
          color: context.watch<ChoosingPageProvider>().selected_profession == Profession ? Color(0xffe9f6ff) : Colors.white,
        borderRadius: BorderRadius.circular(20.0),
          border: Border.all(
            color:  context.watch<ChoosingPageProvider>().selected_profession == Profession ?Color(0xff2667FF):Colors.grey,
          )
      ),
      ...
      child: Padding(
        ...
        child: ListTile(
          title: Text(Profession, style: TextStyle(fontWeight: FontWeight.bold,),),
